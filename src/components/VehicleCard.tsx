...
export const VehicleCard: React.FC<VehicleCardProps> = ({ vehicle, onInquire, onCompare, isComparing }) => {
  return (
    <motion.div
      layout
      whileHover={{ y: -8 }}
      ...
      <div className="p-6 flex flex-col gap-4">
        <div className="flex justify-between items-start">
          ...
          <div className="text-right">
            <span className="text-xs text-muted uppercase tracking-widest font-bold">Price</span>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center justify-between opacity-50 hover:opacity-100 transition-opacity">
            <span className="text-[8px] font-bold uppercase tracking-widest">Technical Data</span>
